...
class registerLandlordToLandlord extends Mailable
{
    ...
    {
        return $this->view('emails.registerLandlordToLandlord')->subject(trans('register.rentling_reposit_realy_next_steps'));
    }
}
