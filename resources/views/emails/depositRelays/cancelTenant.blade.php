                        ...
                        <table style="margin: 0 5em;">
                            ...
                            <tr>
                                ...
                                <td style="padding: 0 0 1em;">
                                    ...
                                    <p>If you had already transferred the deposit to Rentling account, it will be returned to your account.</p>
                                    <p>Regards,</p>
                                ...
                                @else
                                    <td style="padding: 0 0 1em;">
                                        <h1 style="color: #137bb5; text-align: center;">Dear {{ $depositRelay->tenant_first_name.' '. $depositRelay->tenant_last_name }},</h1>
                                        <p> Candidate {{$depositRelay->landlord_name }} has cancelled the deposit relay in the Rentling system for the following address and date: </p>
                                        <p> Address : {{ $property->address }}</p>
                                        <p> Move in Date {{ substr($depositRelay->move_in_date,0,10) }}</p>
                                        <p>The reason for cancellation was: {{$depositRelay->cancel_reason}}</p>
                                        <p>If we had already received the deposit in a Rentling account, it will be returned to your account</p>
                                        <p>Regards,</p>
                                        <p>The Rentling team</p>
                                    </td>
                                @endif
