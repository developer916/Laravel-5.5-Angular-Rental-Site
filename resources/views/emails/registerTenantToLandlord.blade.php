                                                ...
                                                <table style="margin: 0 5em;">
                                                    ...
                                                    <tr>
                                                        <td style="padding: 0 0 1em;">
                                                            <p>{{$deposit_relay->tenant_first_name. ' '. $deposit_relay->tenant_last_name}} signed up with @if($landlordExist == 1) <a href="{{$url}}" target="_blank" rel="noopener noreferrer">Rentling</a> @else <a href="{{$landlordUrl}}" target="_blank" rel="noopener noreferrer">Rentling</a> @endif to transfer the deposit to your account regarding renting of:</p>
                                                            ...
                                                            <table style="width: 100%;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 100%; padding: 1em 0;">
                                                                        ...
                                                                        <p style="padding-left: 16px; text-align: left;">We notify you once&nbsp;the deposit payment arrives in our system.</p>
                                                                    </td>
                                                                    <td style="padding: 1em 0;">&nbsp;</td>
                                                                </tr>
                                                                </tbody>
                                                            ...
                                                            <table style="width: 100%;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 100%; padding: 1em 0;">
                                                                        ...
                                                                        <p style="padding-left: 16px; text-align: left;">{{$deposit_relay->tenant_first_name . ' '. $deposit_relay->tenant_last_name}} expects to move in on {{substr($deposit_relay->move_in_date,0,10)}}</p>
                                                                    </td>
                                                            ...
                                                            <table style="width: 100%;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 100%; padding: 1em 0;">
                                                                        ...
                                                                        <p style="padding-left: 16px; text-align: left;">One day after {{$deposit_relay->tenant_first_name. ' '. $deposit_relay->tenant_last_name}} has&nbsp;moved in, we transfer the deposit payment to your account.</p>
                                                                    </td>
                                                                    <td style="padding: 1em 0;">&nbsp;</td>
                                                                </tr>
                                                                </tbody>
                                    ...
                                    <table border="0" width="100%" cellspacing="0" cellpadding="10">
                                        ...
                                        <tr>
                                            <td colspan="2" valign="middle">
                                                <div><span style="white-space: nowrap;">&nbsp;<a style="color: #137bb5;" href="mailto:support@Rentling.com">Support@Rentling.group</a></span></div>
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <p style="margin: 0px; font-stretch: normal; font-size: 12px; line-height: normal; font-family: Helvetica Neue; color: #454545;">If {{$deposit_relay->tenant_first_name. ' ' . $deposit_relay->tenant_last_name }} cancels payment after Rentling receives it, we will deduct 10% as cancellation fee and pay half to you.</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td valign="top">
