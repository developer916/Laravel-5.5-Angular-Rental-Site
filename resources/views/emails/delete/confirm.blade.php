...
<html lang="en">
<head>
    <title>Rentling | Confirmed delete account</title>
    <meta charset="utf-8">
                                    ...
                                    {{--<table width="100%" border="0" cellspacing="0" cellpadding="0">--}}
                                        {{--<tr>--}}
                                            {{--<td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">--}}
                                                {{--<p>Dear, {{ $name }}, on {{$dateTime}}, you confirmed the full delete of all your data on Rentling. We comply with international laws regarding data privacy and protection and have deleted all your data from out systems. If you had tenants, will not be able to use the tenant App any longer.</p>--}}
                                                {{--<p>Regards,</p>--}}
                                                {{--<p>Rentling team</p>--}}
                                            {{--</td>--}}
                                        {{--</tr>--}}
                                        {{--<tr>--}}
                                            {{--<td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">Enjoy!</td>--}}
                                        {{--</tr>--}}
                                    {{--</table>--}}
                                {{--</td>--}}
                            {{--</tr>--}}
                        ...
                        <table width="500" border="0" cellspacing="0" cellpadding="0" align="center" class="responsive-table">
                            <tr>
                                <td align="center" valign="middle" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
                                    <span class="appleFooter" style="color:#666666;">Rentling / Callcapacity n.v.<br>1 Rue du Potager Luxemburg&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;KVK: 34236451</span><br><br>Bent u geen huurder van bovenstaand adres? Negeer dan dit bericht.
                                </td>
                            </tr>
                        </table>
                    </td>
