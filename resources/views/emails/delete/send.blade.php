...
<html lang="en">
<head>
    <title>rentling | Confirm delete account</title>
    <meta charset="utf-8">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">
                                                <p>This email contains a <a href="{{$confirmLink}}"  target="_blank"> confirm link</a> to remove all your data from Rentling. Please click the link. Please note, this cannot be undone.</p>
                                            </td>
                                        </tr>
                                        <tr>
