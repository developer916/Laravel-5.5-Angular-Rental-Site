...
<html lang="en">
<head>
    <title>Rentling invitation you as landlord</title>
    <meta charset="utf-8">
                ...
                <tr>
                    <td style="border-left: 1px solid #ddd; border-right: 1px solid #ddd;" valign="top">
                        <table style="margin: 0 5em;">
                            ...
                            <tr>
                                <td>
                                    <p>Rentling invitation you as landlord</p>
                                    <p>If you don't have account , Please <a href="{{$url}}" _blank>register</a> to our system</p>
                                </td>
                            </tr>
                            </tbody>
                        </table>
