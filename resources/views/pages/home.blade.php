                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <a href="{{URL::to('news/'.$post->id.'')}}" class="thumbnail"><img
                                        src="https://placehold.it/260x180" alt=""></a>
                        </div>
                        <div class="col-md-10">
                ...
                <div class="col-sm-3">
                    <div class="row">
                        <a href="{{URL::to('video/'.$item->id.'')}}">
                            @if($item->album_image!="")
                                <img class="col-sm-12"
                                     src="{{{'https://img.youtube.com/vi/'.$item->album_image.'/hqdefault.jpg' }}}">
                            @elseif($item->album_image_first!="")
                                <img class="col-sm-12"
                                     src="{{{'https://img.youtube.com/vi/'.$item->album_image_first.'/hqdefault.jpg' }}}">
                            @else
                                <img class="col-sm-12" src="{{'img/default-image.jpg' }}">
                            @endif
                        </a>
